    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
			...
			<li><a href="../ManageRequest/staffRequest.php">Request</a></li>
			...
			<li><a style="font-weight:bold;font-style:italic;" href="Login.php">Log Out</a></li>
        </ul>
          ...
          <div class="carousel-item active" style="background-image: url(../assets/img/hero-carousel/ump.jpg)">
            <div class="carousel-container">
              <div class="container">
                ...
                <a href="../ManageRequest/staffRequest.php" style="text-shadow: 1px 1px;" class="btn-get-started scrollto animate__animated animate__fadeInUp">REQUEST ITEM</a>
              </div>
            </div>
          </div>
