  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
			<li><a href="denyPage.php">Manage Store</a></li>
			<li class="dropdown"><a class="active" href="../ManageRequest/staffRequest.php"><span>Request</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="denyPage.php">Manage Request</a></li>
            </ul>
          </li>
			<li><a href="denyPage.php">Vendor</a></li>
			<li><a href="denyPage.php"><span>Register</span></a></li>
			<li><a href="denyPage.php">Dispense</a></li>
			<li><a href="denyPage.php">Report</a></li>
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(../assets/img/hero-carousel/ump.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 style="color:orange;" class="animate__animated animate__fadeInDown">SORRY</h2>
                <p style="color:red;font-weight:bold;text-shadow: 1px 1px;" class="animate__animated animate__fadeInUp">YOU ARE NOT ALLOWED FOR THIS FUNCTION</p>
                <a href="../ManageRequest/staffRequest.php" class="btn-get-started scrollto animate__animated animate__fadeInUp">BOOK ITEM</a>
              </div>
            </div>
          </div>
